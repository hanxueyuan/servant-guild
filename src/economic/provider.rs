...
impl ProviderSelector {
    ...
    pub fn select(&self, requirements: &ProviderRequirements) -> SelectionResult {
        ...
        if candidates.is_empty() {
            return SelectionResult {
                ...
                pricing: self.pricing_engine.get_model_pricing(LlmProvider::DeepSeek, "deepseek-chat"),
                score: 0.0,
                estimated_cost: 0.0,
            };
        }
    ...
    fn get_candidates(&self, requirements: &ProviderRequirements) -> Vec<(LlmProvider, ModelPricing, f64)> {
    ...
    fn calculate_score(
        ...
        let speed_score = 1.0 - (model.avg_latency_ms as f64 / requirements.max_latency_ms as f64).min(1.0);
